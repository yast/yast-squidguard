...
# File:		modules/Squidguard.pm
# Package:	Configuration of squidguard
# Summary:	Squidguard settings, input and output functions
# Authors:	Lars Vogdt <lars@linux-schulserver.de>
#
# $Id: Squidguard2.pm 27914 2006-02-13 14:32:08Z locilka $
#
# Representation of the configuration of squidguard.
...
sub Read {
    ...
    my $caption = __("Initializing squidguard Configuration");
...
sub Write {
    ...
    # Squidguard read dialog caption
    my $caption = __("Saving squidguard Configuration");
...
##
 # Get all squidguard settings from the first parameter
...
##
 # Dump the squidguard settings to a single map
 # (For use by autoinstallation.)
